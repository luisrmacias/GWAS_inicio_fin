pca <- read.table("ancestrales_adultos_indep.eigenvec", header=TRUE)
	...
	plot(pca$PC1, pca$PC2, col=c("turquoise", "orange","green","black","purple","brown")[pca$pob], pch=18, xlab="First principal component", ylab="Second principal component")
        ...
        legend(0.06, 0.055, levels(pca$pob), bg="white", col=c("turquoise", "orange","green","black","purple","brown"), pch=18, pt.cex=2, y.intersp=1.15)
	dev.off()
